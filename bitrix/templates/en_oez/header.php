...
<script type="text/javascript">
	...
	/*function action_lang(lang){
		...
		if(lang == '') {
			...
			window.location.href = "http://" + domain + trimPath;
		}else{
	...
	function action_lang(lang){
		...
		if(lang == '') {
			...
			window.location.href = "http://sezlipetsk.com" + path;
		}
	...
	<div class="container">
		<div class="col-lg-5 logo col-md-6 col-sm-12 col-xs-12">
			<div class="col-md-3 col-xs-12 logo_img">
				<a href="/">
					<img src="<?=SITE_TEMPLATE_PATH?>/img/logo.png" alt="Special Economic Zone" title="Special Economic Zone">
				</a>
			</div>
			<div class="col-md-9 col-xs-12 logo_text">
				Federal special economic zone of industrial production type "Lipetsk"
			</div>
		</div>
		<div class="col-lg-7 navig col-md-6 col-sm-12 col-xs-12">
			...
			<?$APPLICATION->IncludeComponent(
				...
				array(
					...
					"COMPONENT_TEMPLATE" => "horizontal_multilevel_en"
				),
				false
			);?>
			<!--Верхнее меню-->
