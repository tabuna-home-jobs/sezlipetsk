...
if($arResult["bDescPageNumbering"] === true)
{
	...
	?>
			...
			<?if ($bPrevDisabled):?><span class="disabled"><?=GetMessage("nav_prev")?></span><?else:?><a href="<?=$sPrevHref;?>" class="prev_pagination" id="<?=$ClientID?>_previous_page"></a><?endif;?>&nbsp;<?if ($bNextDisabled):?><span class="disabled"></span><?else:?><a href="<?=$sNextHref;?>" class="next_pagination" id="<?=$ClientID?>_next_page"><?=GetMessage("nav_next")?></a><?endif;?>

<div class="pagintaion_numbers">
	<?
	$bFirst = true;
	$bPoints = false;
	do
...
else
{
	...
	?>
			...
			<?if ($bPrevDisabled):?><span class="disabled"></span><?else:?><a href="<?=$sPrevHref;?>" class="prev_pagination" id="<?=$ClientID?>_previous_page"></a><?endif;?>
...
?>
	...
	<?if ($bNextDisabled):?><span class="disabled"></span><?else:?><a href="<?=$sNextHref;?>" class="next_pagination" id="<?=$ClientID?>_next_page"></a><?endif;?>
</div>
<?CJSCore::Init();?>
