			...
			while ( $ar_Section = $rs_Section->Fetch() )
			{
				...
				while($ar_Section_child = $rs_Section_child->Fetch() ){
					...
					$arResult["razdel"][$ii]["child"][$jj] = array(
						...
						'EXTERNAL_ID' => $ar_Section_child['EXTERNAL_ID'],
						...
						'PREVIEW_PICTURE' => $ar_Section_child['PREVIEW_PICTURE'],
						'DETAIL_PICTURE' => $ar_Section_child['DETAIL_PICTURE'],
						"PREVIEW_TEXT" => $ar_Section_child['PREVIEW_TEXT'],
						"DETAIL_TEXT" => $ar_Section_child['DETAIL_TEXT'],
