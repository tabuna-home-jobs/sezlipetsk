...
<div class="login_form_heder padding_block ">
	<h2 class="h20px_light">Заявка о необходимости снятия показаний существующего прибора учета</h2>
</div>
        ...
        <div class="inputs_container">
            ...
            <div class="row">
                <div class="col-xs-12 labels_left">
                    <span >Просим произвести снятие показаний прибора(-ов) учета электрической энергии </span>
	                <span nameinput="4" style="display: none;">Текст</span>
                </div>
                <div class="col-xs-6 inputs_right" style="display: none;">
                    <input type="email" name="FIELD_4" inputvalue="4" value="Просим произвести снятие показаний прибора(-ов) учета электрической энергии">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6 labels_left">
            ...
            <div class="row">
                    <input type="hidden" value="Заявка о необходимости снятия показаний существующего прибора учета" name="formname">
            </div>
