...
$MESS['SEND_BUTN'] = "ОТПРАВИТЬ";
$MESS['TITLE_OCNK'] = "ПОСТАВИТЬ ОЦЕНКУ";
$MESS['very_bad'] = "Отвратительно";
$MESS['bad'] = "Плохо";
$MESS['normal'] = "Нормально";
$MESS['good'] = "Хорошо";
$MESS['very_good'] = "Отлично";
$MESS['ocenka_title'] = "Оценка";
$MESS['messs'] = "Сообщение";
$MESS['choose_theme'] = "Выберите тему";
