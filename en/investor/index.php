		...
		<section class="container ">
				...
				<div class="col-md-6">
					...
					<div>
						...
						<div class="more_about">
							<a href="/en/investor/o-regione/" class="all">Подробнее о регионе <span class="glyphicon glyphicon-menu-right"></span></a>
						</div>
					</div>
					<div>
			...
			<div class="map_container">
				<div class="map_back">
					<div>
						<div>
							<a class="map_link" href="/en/map/">Интерактивная карта</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 ">
					<div class="col-lg-6 col-xs-12 col-sm-12 col-md-6 block_item">
						<div class="item_block">
							<a href="/en/investor/lgotnoe-predostavlenie-zemelnykh-uchastkov/" class="item_block_a" >
					...
					<div class="col-lg-6 col-xs-12 col-sm-12 col-md-6 block_item">
						<div class="item_block">
							<a href="/en/investor/prezentatsii-dlya-zagruzki/" class="item_block_a" >
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-lg-3 col-md-6 col-xs-6 col-sm-6 block_item">
						<div class="item_block">
							<a href="/en/investor/nalogovye-lgoty/" class="item_block_a_small">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-lg-3 col-md-6 col-xs-6 col-sm-6 block_item">
						<div class="item_block">
							<a href="/en/investor/tamozhennye-lgoty/" class="item_block_a_small">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-md-12 col-lg-6 col-xs-12 block_item">
						<div class="item_block">
							<a href="/en/investor/uslugi-dlya-rezidentov/" class="item_block_a" >
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
				...
				<div class="col-md-6 ">
					<div class="col-sm-6 col-xs-6 block_item col-md-12 col-lg-6">
						<div class="item_block hight_item_block">
							<a href="/en/investor/zakonodatelstvo/" class="item_block_a" >
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
									...
									<div class="item_dop">
										«Деятельность компаний-инвесторов регулируется федеральными и региональными нормативными актами»
									</div>
								</div>
								<div class="block_icon">
                            <span class="item_block_img">
					...
					<div class="col-sm-6 col-xs-6 col-md-12 col-lg-6 block_item">
						<div class="item_block hight_item_block">
							<a href="/en/investor/perspektivy-rasshireniya-territorii/" class="item_block_a" >
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6">
						<a href="/en/investor/promyshlennaya-infrastruktura-oez/" class="inform_item_a">
					...
					<div class="col-md-6">
						<a href="/en/investor/sotsialnaya-infrastruktura-oez/" class="inform_item_a">
							<div class="inform_item row">
								<div class="col-xs-6 inform_text">
									<div class="small_text">
										а так же
