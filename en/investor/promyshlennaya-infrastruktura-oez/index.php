...
$APPLICATION->SetTitle("Industrial infrastructure");
?>
	<div class="main ">
				...
				<div class="col-md-6 ">
					<div class="col-lg-6 col-xs-12 col-sm-12 col-md-6 block_item">
						<div class="item_block">
							<a class="item_block_a" href="/en/map/#net-electro">
					...
					<div class="col-lg-6 col-xs-12 col-sm-12 col-md-6 block_item">
						<div class="item_block">
							<a href="/en/map/#net-hot" class="item_block_a">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-lg-3 col-md-6 col-xs-6 col-sm-6 block_item">
						<div class="item_block">
							<a class="item_block_a_small" href="/en/map/#water-net">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-lg-3 col-md-6 col-xs-6 col-sm-6 block_item">
						<div class="item_block">
							<a class="item_block_a_small" href="/en/map/#net-abduction">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-md-12 col-lg-6 col-xs-12 block_item">
						<div class="item_block">
							<a class="item_block_a" href="/en/map/#net-gaz">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
				...
				<div class="col-md-6 ">
					<div class="col-sm-6 col-xs-12 col-md-12 col-lg-6 block_item">
						<div class="item_block hight_item_block">
							<a href="/en/map/#net-tele" class="item_block_a">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
					...
					<div class="col-sm-6 col-xs-12 col-md-12 col-lg-6 block_item">
						<div class="item_block hight_item_block">
							<a class="item_block_a" href="/en/investor/promyshlennaya-infrastruktura-oez/tekhnologicheskoe-prisoedinenie-podklyuchenie/">
								<div class="hover_container">
									<div class="hover"></div>
								</div>
								<div class="item_bod">
