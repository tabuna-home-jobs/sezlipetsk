<?
	...
	$APPLICATION->SetTitle("Просмотреть переданные показания приборов учета");
?>
...
<div class="main container">
	<div class="col-xs-12 col-md-6">
		...
		?>
		<!--Хлебные крошки-->
		<h1>Просмотреть переданные показания приборов учета</h1>
		...
		<div class="login_form_container padding_block">
			<div class="row login_form_heder">
				<a href="#login_panel" id="electro-tab1" role="tab" class="login_punct active_login_punkt"
				   ...
				   aria-expanded="true">Переданные показания приборов учета</a>
			</div>
