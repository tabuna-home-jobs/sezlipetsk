	...
	<div class="main container">
			...
			<div class="container">
				<div class="row top_block">
					...
					<div class="hidden-xs hidden-sm right_part col-xs-12 col-sm-12 col-md-5">
						<img src="<?=SITE_TEMPLATE_PATH?>/img/building.jpg">
					</div>
				</div>
			</div>
		</section>
		...
		<section class="what_we_are row">
			<div class="row">
				<div class="col-md-3 item_company_action row ">
					<div class="compan_action_img col-md-12 col-xs-3"><img src="<?=SITE_TEMPLATE_PATH?>/img/marker.png"></div>
				...
				<div class="col-md-3 item_company_action row ">
					<div class="compan_action_img col-md-12 col-xs-3"><img src="<?=SITE_TEMPLATE_PATH?>/img/two.png"></div>
				...
				<div class="col-md-3 item_company_action row ">
					<div class="compan_action_img col-md-12 col-xs-3"><img src="<?=SITE_TEMPLATE_PATH?>/img/cup.png"></div>
				...
				<div class="col-md-3 item_company_action row ">
					<div class="compan_action_img col-md-12 col-xs-3"><img src="<?=SITE_TEMPLATE_PATH?>/img/mebel.png"></div>
		...
		<section class="cennosti">
			...
			<div class="row cennost_items">
				<div class="col-md-4">
					<div class="cennost_name"><img src="<?=SITE_TEMPLATE_PATH?>/img/ok.png">Ответственность</div>
				...
				<div class="col-md-4">
					<div class="cennost_name"><img src="<?=SITE_TEMPLATE_PATH?>/img/ok.png">Патриотизм</div>
				...
				<div class="col-md-4">
					<div class="cennost_name"><img src="<?=SITE_TEMPLATE_PATH?>/img/ok.png">Лидерство</div>
				...
				<div class="col-md-4">
					<div class="cennost_name"><img src="<?=SITE_TEMPLATE_PATH?>/img/ok.png">Единство</div>
					<div class="cennost_body">Мы - команда, сила которой во взаимной поддержке и уважении мнения каждого.
					</div>
				</div>
				<div class="col-md-4">
					<div class="cennost_name"><img src="<?=SITE_TEMPLATE_PATH?>/img/ok.png">Открытость</div>
				...
				<div class="col-md-4">
					<div class="cennost_name"><img src="<?=SITE_TEMPLATE_PATH?>/img/ok.png">Развитие</div>
